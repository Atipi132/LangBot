...
//            }
    ...
    private fun getMessageFromAI() {
        val httpThread = Thread {
            ...
            val body = "{\"messages\": $messages, \"srcLang\": \"$nativeLanguageAbbreviation\", \"outLang\": \"$nativeLanguageAbbreviation\"}".toRequestBody(mediaType)
            Log.d("RequestBody" ,"{\"messages\": $messages}")
